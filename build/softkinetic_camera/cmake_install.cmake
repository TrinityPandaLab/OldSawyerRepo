# Install script for directory: /home/lab/ros_ws/src/softkinetic_camera
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig" TYPE FILE FILES "/home/lab/ros_ws/build/softkinetic_camera/catkin_generated/installspace/softkinetic_camera.pc")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/softkinetic_camera/cmake" TYPE FILE FILES
    "/home/lab/ros_ws/build/softkinetic_camera/catkin_generated/installspace/softkinetic_cameraConfig.cmake"
    "/home/lab/ros_ws/build/softkinetic_camera/catkin_generated/installspace/softkinetic_cameraConfig-version.cmake"
    )
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/softkinetic_camera" TYPE FILE FILES "/home/lab/ros_ws/src/softkinetic_camera/package.xml")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/softkinetic_camera/config" TYPE DIRECTORY FILES "/home/lab/ros_ws/src/softkinetic_camera/config/")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/softkinetic_camera/launch" TYPE DIRECTORY FILES "/home/lab/ros_ws/src/softkinetic_camera/launch/")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/softkinetic_camera/meshes" TYPE DIRECTORY FILES "/home/lab/ros_ws/src/softkinetic_camera/meshes/")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/softkinetic_camera/urdf" TYPE DIRECTORY FILES "/home/lab/ros_ws/src/softkinetic_camera/urdf/")
endif()
