...
class IODeviceStatus(genpy.Message):
  _md5sum = "718c67c597ae650d738fb6d34d8bb893"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.device.status.key
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.device.status.msg
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.device.status.key = str[start:end].decode('utf-8')
      else:
        self.device.status.key = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.device.status.msg = str[start:end].decode('utf-8')
      else:
        self.device.status.msg = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ports = []
      for i in range(0, length):
        ...
        if python3:
          _v3.key = str[start:end].decode('utf-8')
        else:
          _v3.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v3.msg = str[start:end].decode('utf-8')
        else:
          _v3.msg = str[start:end]
      ...
      for i in range(0, length):
        ...
        if python3:
          _v4.msg = str[start:end].decode('utf-8')
        else:
          _v4.msg = str[start:end]
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v7.key = str[start:end].decode('utf-8')
        else:
          _v7.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v7.msg = str[start:end].decode('utf-8')
        else:
          _v7.msg = str[start:end]
        self.ports.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v8.msg = str[start:end].decode('utf-8')
        else:
          _v8.msg = str[start:end]
        self.signals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
