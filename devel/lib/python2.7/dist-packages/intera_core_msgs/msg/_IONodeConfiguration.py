...
class IONodeConfiguration(genpy.Message):
  _md5sum = "d4876a14c772246335a974bf5f29be1e"
...
"""
  __slots__ = ['time','node','devices']
  _slot_types = ['time','intera_core_msgs/IOComponentConfiguration','intera_core_msgs/IOComponentConfiguration[]']
